"""Dialog plugin for managing game dialogs and conversations.

This module provides the dialog display plugin used throughout the game for
...
The dialog plugin is typically used through:
...
class DialogManager(DialogBaseManager):
    ...
    - Used by DialogAction in the scripting plugin for cutscenes
        ...
        *,
        ...
        Args:
            ...
            instant: If True, text appears immediately without letter-by-letter reveal.
                Useful for narration, plugin messages, or cutscenes where the reveal
    ...
    def get_current_page(self) -> DialogPage | None:
        ...
        Note:
            Returns None if the dialog plugin is not currently showing a dialog or
