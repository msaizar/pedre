...
This module provides a lightweight particle plugin for adding visual feedback and
...
class ParticleManager(ParticleBaseManager):
    ...
    def update(self, delta_time: float) -> None:
        ...
        Args:
            ...
            context: Game context (optional, for BasePlugin compatibility).
        """
    ...
    def draw(self) -> None:
        ...
        When the particle plugin is disabled, this method returns immediately without
        rendering anything.
        """
        if not self.enabled:
            return
    ...
    def clear(self) -> None:
        ...
        Immediately removes all particles from the plugin. This is useful for:
        - Scene transitions where particles should not carry over
        - Resetting visual state
        - Cleanup when disabling the particle plugin
    ...
    def toggle(self) -> bool:
        ...
        Switches the particle plugin between enabled and disabled states. When
        ...
        This is useful for:
        - Performance optimization on slower plugins
