...
- Full flexibility through script plugin (conditions, actions, change_scene)
...
- Map loading plugin registers portals during initialization
- EventBus receives PortalEnteredEvent when player enters portal
- Script plugin handles transitions via change_scene action
- Full condition plugin from scripts applies to portal transitions
